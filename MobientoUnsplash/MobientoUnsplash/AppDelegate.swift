...
class AppDelegate: UIResponder, UIApplicationDelegate {
    ...
    func application(_ application: UIApplication, didFinishLaunchingWithOptions launchOptions: [UIApplicationLaunchOptionsKey: Any]?) -> Bool {
        ...
        let searchStoryboard = UIStoryboard(name: MUViewControllers.searchView.storyboardName, bundle: nil)
        let searchViewController = searchStoryboard.instantiateViewController(withIdentifier: MUViewControllers.searchView.storyboardIdentifier)
